	...
	return (
		<div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
			...
			<div className="flex gap-4 my-5">
				<button
					type="button"
					className="w-1/2 py-2 px-10 bg-indigo-600 hover:bg-indigo-700 text-white uppercase font-bold  rounded-lg"
					onClick={() => setEdicion(paciente)}
				>Editar</button>

				<button
					type="button"
					className="w-1/2 py-2 px-10 bg-red-600 hover:bg-red-700 text-white uppercase font-bold  rounded-lg"
